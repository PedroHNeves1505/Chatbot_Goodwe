...
prompt_analise = ChatPromptTemplate.from_template(SYSTEM_PROMPT + "\n\n{format_instructions}")
...
prompt_resposta = ChatPromptTemplate.from_template(SYSTEM_PROMPT + "\n\n{format_instructions}")
...
def executar_chatbot():
    ...
    # Obtem a pergunta do usuário
    pergunta_usuario = input("Digite sua pergunta sobre o Fierljeppen: ")
